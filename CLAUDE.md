...
9. **Install hook once per clone**: `npm run hooks:install` (blocks `main` pushes when plugin files change without a version bump, and enforces tag+release+assets on bumped versions)
...
- Current canonical release: `v2.0.23`
